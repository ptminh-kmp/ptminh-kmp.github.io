...
tags:
  ...
  - GitHub Actions
  - Flutter
image: https://rustfs.minixium.com/minixium-blog-bucket/cicd-flutter-fastlane-github-tesflight-vi.png
mermaid: true
---
...
```
  ...
  _Lưu ý: Nếu bước này lỗi, hãy fix các vấn đề liên quan đến Flutter/Signing trước khi tiếp tục với Fastlane._
...
```
  ...
  _Kết quả thành công sẽ thấy dòng chữ: `[✔] All required keys, certificates and provisioning profiles are installed 🙌`_
  -----
