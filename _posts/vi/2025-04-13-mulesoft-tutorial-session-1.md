...
graph TD
    subgraph Ví dụ Kiến trúc Spaghetti
        ...
        %% Định nghĩa các kết nối rối rắm (edges)
        CRM --- ERP
        ERP --- WebStore
        WebStore --- Inventory
        HR --- ERP
...
graph TD
    subgraph Ví dụ về Kiến trúc API Gateway
        ...
        %% Định nghĩa Khách hàng ở trên cùng
        ...
        %% Định nghĩa Microservices hoặc API Backend ở dưới cùng
        ...
        %% Kết nối: Khách hàng kết nối với Gateway
