...
| App version | Debugging | No | 90 days |
...
- Uses Google AdMob  
- May collect advertising ID (IDFA / GAID)  
...
- Reads notification text from banking apps  
...
- Encrypted data stored via Supabase  
- Requires account  
